...
<body style="background-color:rgb(89, 218, 89);">
  <div class="container mt-5">
    ...
    <div class="row mt-5">
      <div class="col-md-12">
        <h5 class="d-flex justify-content-start align-items-center">Kontrol Lampu <ion-icon name="settings-outline" class="ml-2"></ion-icon></h5>
      </div>
